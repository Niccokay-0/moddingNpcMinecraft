...
public class EntityNpc extends PathfinderMob {
    ...
    private static final EntityDataAccessor<String> DATA_NAME = SynchedEntityData.defineId(EntityNpc.class, EntityDataSerializers.STRING);
    private static final EntityDataAccessor<String> DATA_SURNAME = SynchedEntityData.defineId(EntityNpc.class, EntityDataSerializers.STRING);
    private static final EntityDataAccessor<String> DATA_GENDER = SynchedEntityData.defineId(EntityNpc.class, EntityDataSerializers.STRING);
    private static final EntityDataAccessor<Integer> DATA_VARIANT = SynchedEntityData.defineId(EntityNpc.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<String> DATA_PROFESSION = SynchedEntityData.defineId(EntityNpc.class, EntityDataSerializers.STRING);
    private static final EntityDataAccessor<Float> DATA_HAPPINESS = SynchedEntityData.defineId(EntityNpc.class, EntityDataSerializers.FLOAT);

    public EntityNpc(EntityType<? extends PathfinderMob> pEntityType, Level pLevel) {
